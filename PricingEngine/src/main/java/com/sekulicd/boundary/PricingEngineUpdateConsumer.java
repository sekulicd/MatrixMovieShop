...
@Startup
@Singleton
public class PricingEngineUpdateConsumer {
    ...
    @PostConstruct
    private void init() {
        kafkaProperties.put("group.id", "pricing-engine-consumer-" + UUID.randomUUID());
        String orders = kafkaProperties.getProperty("moviepricingengine.topic");
